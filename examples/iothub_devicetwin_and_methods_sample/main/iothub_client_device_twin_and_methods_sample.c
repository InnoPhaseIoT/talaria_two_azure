...
static void deviceTwinCallback(DEVICE_TWIN_UPDATE_STATE update_state, const unsigned char* payLoad, size_t size, void* userContextCallback)
{
    ...
    {
        os_printf("Error: JSON parsing failed!\r\n");
    }
}
...
static void iothub_client_device_twin_and_methods_sample_run(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            //Note : uncommenting above lines resulted in undefined reference to `IoTHubDeviceClient_SetOption'
            //useing 'IoTHubClient_LL_SetOption' builds and and gives traces succesfull.
            // Comment below lines to disable verboce trace logs.
            ...
            {
                os_printf("failure to set option \"TrustedCerts\"\r\n");
            }
#endif // SET_TRUSTED_CERT_IN_SAMPLES
            ...
            {
                os_printf("Error: JSON serialization failed!\r\n");
            }
